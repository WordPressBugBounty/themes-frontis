...
$home_url =  home_url();
?>
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"frontis/footer-flamingo","name":"Footer Flamingo"},"align":"full","style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|spacing-104","bottom":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}},"color":{"background":"#330f06"}},"layout":{"type":"constrained"},"anchor":"footer"} -->
...
<p class="has-text-color has-link-color has-p-1-font-size" style="color:#ffede9">Copyright @ 2026 - WordPress Theme by <a href="https://wpmessiah.com/" aria-label="Visit WP Messiah's website">WP Messiah</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
