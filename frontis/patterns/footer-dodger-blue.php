<?php
/**
 * Title: Footer Dodger Blue
 * Slug: frontis/footer-dodger-blue
 * Categories: footer
 */
...
$home_url =  home_url();
?>
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"frontis/footer-dodger-blue","name":"Footer Dodger Blue"},"style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|spacing-104","bottom":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"},"anchor":"footer"} -->
<div id="footer" class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--spacing-104);padding-bottom:var(--wp--preset--spacing--medium)"><!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"top":"0","left":"var:preset|spacing|spacing-32"},"padding":{"right":"var:preset|spacing|spacing-32","left":"var:preset|spacing|spacing-32","top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
...
<figure class="wp-block-image size-full is-resized"><a href="<?php echo $home_url; ?>"><img src="<?php echo esc_url($images[0]); ?>" alt="site-logo" class="wp-image-451" style="width:110px"/></a></figure>
<!-- /wp:image -->
...
<div class="wp-block-column"><!-- wp:heading {"level":6,"align":"wide","style":{"elements":{"link":{"color":{"text":"var:preset|color|background-white"}}},"typography":{"fontStyle":"normal","fontWeight":"600"},"spacing":{"padding":{"bottom":"0","left":"0","right":"0","top":"0"},"margin":{"top":"0","bottom":"0","left":"0","right":"0"}}},"textColor":"background-white","fontSize":"h6"} -->
<h6 class="wp-block-heading alignwide has-background-white-color has-text-color has-link-color has-h-6-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;font-style:normal;font-weight:600">Information</h6>
<!-- /wp:heading -->
...
<div class="wp-block-column"><!-- wp:heading {"level":6,"align":"wide","style":{"elements":{"link":{"color":{"text":"var:preset|color|background-white"}}},"typography":{"fontStyle":"normal","fontWeight":"600"},"spacing":{"padding":{"bottom":"0","top":"0","right":"0"},"margin":{"top":"0","bottom":"0","left":"0","right":"0"}}},"textColor":"background-white","fontSize":"h6"} -->
<h6 class="wp-block-heading alignwide has-background-white-color has-text-color has-link-color has-h-6-font-size" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;font-style:normal;font-weight:600">Company</h6>
<!-- /wp:heading -->
...
<div class="wp-block-group has-primary-800-background-color has-background" style="border-radius:15px;padding-top:var(--wp--preset--spacing--spacing-24);padding-right:var(--wp--preset--spacing--spacing-24);padding-bottom:var(--wp--preset--spacing--spacing-24);padding-left:var(--wp--preset--spacing--spacing-24)"><!-- wp:heading {"level":6,"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"margin":{"bottom":"var:preset|spacing|spacing-16"}}},"textColor":"white","fontSize":"h6"} -->
<h6 class="wp-block-heading has-white-color has-text-color has-link-color has-h-6-font-size" style="margin-bottom:var(--wp--preset--spacing--spacing-16)">Subscribe</h6>
<!-- /wp:heading -->
...
<p class="has-background-white-color has-text-color has-link-color has-p-1-font-size"><?php echo sprintf(esc_html__('Copyright @ %1$s - WordPress Theme by %2$s', 'frontis'), esc_html($current_year), '<a href="' . esc_url($theme_author_link) . '" aria-label="Visit ' . esc_attr($theme_author_name) . '\'s website">' . esc_html($theme_author_name) . '</a>'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
