<?php
/**
 * Title: Contact Las Palmas
 * Slug: frontis/contact-las-palmas
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|spacing-16","bottom":"var:preset|spacing|spacing-40"}},"color":{"text":"#fafdeb"},"elements":{"link":{"color":{"text":"#fafdeb"}}}}} -->
...
<!-- wp:paragraph {"style":{"color":{"text":"#fafdeb"},"elements":{"link":{"color":{"text":"#fafdeb"}}}}} -->
<p class="has-text-color has-link-color" style="color:#fafdeb">832 Thompson Drive, San Fransisco CA 94107, United States</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"color":{"text":"#fafdeb"},"elements":{"link":{"color":{"text":"#fafdeb"}}}}} -->
<p class="has-text-color has-link-color" style="color:#fafdeb">+123 345123 556</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"color":{"text":"#fafdeb"},"elements":{"link":{"color":{"text":"#fafdeb"}}}}} -->
<p class="has-text-color has-link-color" style="color:#fafdeb">support@frontis.com</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","style":{"border":{"radius":"12px"},"spacing":{"padding":{"top":"var:preset|spacing|spacing-32","bottom":"var:preset|spacing|spacing-32","left":"var:preset|spacing|spacing-32","right":"var:preset|spacing|spacing-32"}},"color":{"background":"#3d4711"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-column is-vertically-aligned-center has-background" style="border-radius:12px;background-color:#3d4711;padding-top:var(--wp--preset--spacing--spacing-32);padding-right:var(--wp--preset--spacing--spacing-32);padding-bottom:var(--wp--preset--spacing--spacing-32);padding-left:var(--wp--preset--spacing--spacing-32)"><!-- wp:heading {"level":3,"style":{"color":{"text":"#ffffff"},"elements":{"link":{"color":{"text":"#ffffff"}}}},"fontSize":"h5"} -->
<h3 class="wp-block-heading has-text-color has-link-color has-h-5-font-size" style="color:#ffffff">We’d love to help</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|spacing-16","bottom":"var:preset|spacing|spacing-32"}},"color":{"text":"#fafdeb"},"elements":{"link":{"color":{"text":"#fafdeb"}}}}} -->
<p class="has-text-color has-link-color" style="color:#fafdeb;margin-top:var(--wp--preset--spacing--spacing-16);margin-bottom:var(--wp--preset--spacing--spacing-32)">Interactive design tools and its many customization to customize anything functional dreams.</p>
<!-- /wp:paragraph -->
