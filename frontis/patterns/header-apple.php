...
$home_url =  home_url();
?>
<!-- wp:group {"metadata":{"name":"Header Apple","categories":["header"],"patternName":"frontis/header-dodger-blue"},"align":"wide","style":{"spacing":{"blockGap":"0","padding":{"right":"var:preset|spacing|spacing-32","left":"var:preset|spacing|spacing-32"}}},"layout":{"type":"default"}} -->
...
<div class="wp-block-button" style="font-style:normal;font-weight:500"><a class="wp-block-button__link has-text-color has-background has-link-color wp-element-button" href="#" style="color:#173518;background-color:#ffffff" rel="" aria-label="Contact us">Contact us</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
