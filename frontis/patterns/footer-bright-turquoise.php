...
$home_url =  home_url();
?>
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"frontis/footer-bright-turquoise","name":"Footer dodger blue"},"style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|spacing-104","bottom":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}},"color":{"background":"#001514"}},"layout":{"type":"constrained"}} -->
...
<p class="has-text-color has-link-color has-p-1-font-size" style="color:#ccfffc">Copyright @ 2026 - WordPress Theme by <a href="https://wpmessiah.com/" aria-label="Visit WP Messiah's website">WP Messiah</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:paragraph {"className":"has-text-color has-link-color","style":{"elements":{"link":{"color":{"text":"#ccfffc"}}},"typography":{"fontStyle":"normal","fontWeight":"400","textAlign":"center"},"color":{"text":"#ccfffc"}},"fontSize":"p-1"} -->
<p class="has-text-align-center has-text-color has-link-color has-p-1-font-size" style="color:#ccfffc;font-style:normal;font-weight:400">Copyright @ 2026 - WordPress Theme by <a href="https://wpmessiah.com/" aria-label="Visit WP Messiah's website">WP Messiah</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
