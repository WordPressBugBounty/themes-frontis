...
$home_url =  home_url();
?>
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"frontis/footer-las-palmas","name":"Footer Las Palmas"},"align":"full","style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|spacing-104","bottom":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}},"color":{"background":"#292f0b"}},"layout":{"type":"constrained"}} -->
...
<p class="has-text-color has-link-color has-p-1-font-size" style="color:#fafdeb"><?php echo sprintf(esc_html__('Copyright @ %1$s - WordPress Theme by %2$s', 'frontis'), esc_html($current_year), '<a href="' . esc_url($theme_author_link) . '" aria-label="Visit ' . esc_attr($theme_author_name) . '\'s website">' . esc_html($theme_author_name) . '</a>'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
