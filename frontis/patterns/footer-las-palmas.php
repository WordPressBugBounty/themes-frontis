<?php
/**
 * Title: Footer Las Palmas
 * Slug: frontis/footer-las-palmas
 * Categories: footer
 */
...
$home_url =  home_url();
?>
<!-- wp:group {"metadata":{"categories":["footer"],"patternName":"frontis/footer-las-palmas","name":"Footer Las Palmas"},"align":"full","style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|spacing-104","bottom":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}},"color":{"background":"#292f0b"}},"layout":{"type":"constrained"},"anchor":"footer"} -->
<div class="wp-block-group alignfull has-background" id="footer" style="background-color:#292f0b;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--spacing-104);padding-bottom:var(--wp--preset--spacing--medium)"><!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"top":"0","left":"var:preset|spacing|spacing-32"},"padding":{"right":"var:preset|spacing|spacing-32","left":"var:preset|spacing|spacing-32","top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#fafdeb"}}},"typography":{"fontSize":"18px","fontStyle":"normal","fontWeight":"400"},"spacing":{"margin":{"top":"var:preset|spacing|spacing-16","right":"var:preset|spacing|spacing-32","bottom":"var:preset|spacing|spacing-24","left":"0"}},"color":{"text":"#fafdeb"}}} -->
<p class="has-text-color has-link-color" style="color:#fafdeb;margin-top:var(--wp--preset--spacing--spacing-16);margin-right:var(--wp--preset--spacing--spacing-32);margin-bottom:var(--wp--preset--spacing--spacing-24);margin-left:0;font-size:18px;font-style:normal;font-weight:400">We’re a diverse and passionate team that takes ownership of your design and empower you.</p>
<!-- /wp:paragraph -->
...
<!-- wp:navigation {"customTextColor":"#fafdeb","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|spacing-16"},"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"p-1","layout":{"type":"flex","orientation":"vertical"}} -->
...
<!-- wp:navigation {"customTextColor":"#fafdeb","overlayMenu":"never","style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"spacing":{"blockGap":"var:preset|spacing|spacing-16"}},"fontSize":"p-1","layout":{"type":"flex","orientation":"vertical"}} -->
...
<div class="wp-block-column" style="padding-top:0;padding-bottom:var(--wp--preset--spacing--xx-small)"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|spacing-24","bottom":"var:preset|spacing|spacing-24","left":"var:preset|spacing|spacing-24","right":"var:preset|spacing|spacing-24"}},"border":{"radius":"15px"},"color":{"background":"#525f16"}},"layout":{"type":"constrained","justifyContent":"center","contentSize":""}} -->
<div class="wp-block-group has-background" style="border-radius:15px;background-color:#525f16;padding-top:var(--wp--preset--spacing--spacing-24);padding-right:var(--wp--preset--spacing--spacing-24);padding-bottom:var(--wp--preset--spacing--spacing-24);padding-left:var(--wp--preset--spacing--spacing-24)"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|spacing-16"}},"color":{"text":"#ffffff"},"elements":{"link":{"color":{"text":"#ffffff"}}}},"fontSize":"h6"} -->
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#fafdeb"}}},"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"margin":{"top":"var:preset|spacing|spacing-16","right":"0","bottom":"0","left":"0"}},"color":{"text":"#fafdeb"}},"fontSize":"p-1"} -->
<p class="has-text-color has-link-color has-p-1-font-size" style="color:#fafdeb;margin-top:var(--wp--preset--spacing--spacing-16);margin-right:0;margin-bottom:0;margin-left:0;font-style:normal;font-weight:400">Hello, we are Justwp. Our goal is to translate the positive effects from revolutionizing how companies engage with their clients</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:separator {"align":"wide","className":"is-style-wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|spacing-88","bottom":"0"}},"color":{"background":"#3d4711"}}} -->
<hr class="wp-block-separator alignwide has-text-color has-alpha-channel-opacity has-background is-style-wide" style="margin-top:var(--wp--preset--spacing--spacing-88);margin-bottom:0;background-color:#3d4711;color:#3d4711"/>
<!-- /wp:separator -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#fafdeb"}}},"color":{"text":"#fafdeb"}},"fontSize":"p-1"} -->
<p class="has-text-color has-link-color has-p-1-font-size" style="color:#fafdeb">Copyright @ 2026 - WordPress Theme by <a href="https://wpmessiah.com/" aria-label="Visit WP Messiah's website">WP Messiah</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:navigation {"customTextColor":"#fafdeb","overlayMenu":"never","style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"p-2","layout":{"type":"flex","justifyContent":"right"}} -->
